...
class JJKShitpostExt(Extension):
	jjk_shitpost = SlashCommand(name='jjk-shitpost', description='Includes all of the Lobotomy essentials!')

	@jjk_shitpost.subcommand(sub_cmd_name='are-you-because', sub_cmd_description='Are you X because you are Y, or are you Y because you are X?')
